...
- 现有代码：自研 `hello_agents` 框架 + ReconciliationAgent + 7 个工具 + 4 条 demo
- 团队：单人开发（mabohui）
...
**决策**：废弃 `hello_agents/core/agent.py` 自研编排，全量迁移至 LangGraph StateGraph。
...
1. `git mv hello_agents/ legacy/hello_agents/`
